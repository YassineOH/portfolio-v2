...
export const buttonVariants = ({
  ...
  return [
    'cursor-pointer w-auto rounded-full no-underline  font-base font-semibold shadow-primary transition-all duration-300 hover:scale-95 hover:shadow-[0px_0px_200px_2px] hover:shadow-primary hover:brightness-105',
    {
